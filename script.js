...
const perguntasERespostas = [
    ...
    { pergunta: "O que é leptospirose?", resposta: "R: Uma doença transmitida pelo mouse" },
    { pergunta: "Qual é a diferença entre um jacaré e um tamanduá ?", resposta: "R: Um é jacaré e outro um tamanduá" },
    { pergunta: "Por que todo mundo gosta do Stan Lee?", resposta: "R: Porque ele é uma pessoa ARmavel" }, 
    { pergunta: "O que é que tem asa, mas não voa, tem bico, mas não bica e tem perna, mas não anda?", resposta: "R: Um passaro morto" }, 
    { pergunta: "Por que o bombeiro não gosta de andar?", resposta: "R: Porque ele socorre" }, 
    { pergunta: "Qual é o doce preferido dos átomos?", resposta: "R: Pé de moléculas" }, 
    { pergunta: "Duas hemoglobinas assistem a televisão. Uma delas elogia a imagem da TV. O que a outra responde?", resposta: "R: Porque é plasma" }, 
    { pergunta: "Por que o pinheiro nunca se perde na floresta?", resposta: "R: Porque ele tem uma pinha" },
    { pergunta: "Qual é a peça de roupa que os personagens de Dragon Ball Z usam?", resposta: "R: Super saia jeans (Super sayajins)" },
    { pergunta: "Qual é a fruta que sempre fica em segundo lugar?", resposta: "R: A banana prata" }, 
    { pergunta: "O do Arnold Schwarzenegger é grande, o do Donald Trump é pequeno e a Madonna não tem. O que é?", resposta: "R: O sobrenome" }, 
    { pergunta: "O que a vaca tem quatro e a mulher tem apenas duas?", resposta: "R: Pernas" }, 
    { pergunta: "O que a uva verde falou para a uva roxa?", resposta: "R: Ai, meu Deus! Respira, respira!" }, 
    { pergunta: "Quais são as únicas 6 pessoas que sofrem quando a economia vai mal?", resposta: "R: eu, tu, ele, nós, vós e eles" },
    { pergunta: "O que pesa um açougueiro de 1,95 m?", resposta: "R: Carne" },
    { pergunta: "Quais são as duas palavras que abrem muitas portas?", resposta: "R: puxe e empurre" },
    { pergunta: "O que é pequeno em Lisboa e grande no Brasil?", resposta: "R: A letra B" }, 
    { pergunta: "O que o químico disse ao encontrar dois átomos de hélio?", resposta: "R: He He! (He é o símbolo do elemento químico Hélio)" },
    { pergunta: "O que é meu, mas meus amigos usam mais que eu?", resposta: "Meu nome" },
    { pergunta: "O que o zero disse para o oito?", resposta: "R: Belo cinto!" }, 
];
